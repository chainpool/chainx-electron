const zh_en = {
  ...
  ResponseList: ['处理列表', 'Response List'],
  HaveSigned: ['已签名', 'Signed'],
  Sign: ['签名', 'Sign'],
  VetoedSign: ['否决', 'Veto'],
  HaveVetoedSign: ['已否决', 'Vetoed'],
  NoResponseSign: ['未处理', 'No Response'],
  CopyOriginalDataToSigned: ['复制待签原文', 'Copy Original Data to be signed'],
  Tx: ['原文', 'Tx'],
  RespondMultiSigWithdrawal: ['处理多签提现', 'Respond the MultiSig Withdrawal'],
  ...
  ResponseOkThenDealing: ['已广播', 'broadcasting'],
