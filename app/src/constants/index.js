...
export const DowloadWalletUrl = {
  Win: 'https://chainx-wallet-release.oss-cn-hangzhou.aliyuncs.com/1.0.5/chainx-1.0.5-win.zip',
  Mac: 'https://chainx-wallet-release.oss-cn-hangzhou.aliyuncs.com/1.0.5/chainx-1.0.5.dmg',
  Linux: 'https://chainx-wallet-release.oss-cn-hangzhou.aliyuncs.com/1.0.5/chainx-1.0.5-x86_64.AppImage',
};
